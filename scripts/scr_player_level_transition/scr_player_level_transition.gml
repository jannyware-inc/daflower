...
function scr_player_level_transition(){
	...
	x = floor(twerp(TwerpType.out_quad, state_var_0, global.player_start_pos[state_var_2].x,  _percent));
	y = floor(camera_get_view_y(view_camera[0]) + twerp(TwerpType.out_quad, state_var_1, _to_screen_y, _percent));
